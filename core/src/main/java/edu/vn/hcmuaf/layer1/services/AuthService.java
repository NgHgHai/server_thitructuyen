...
//import io.herosnake.layer2.dao.Game;
//import io.herosnake.layer2.dao.UserDAO;
//import io.herosnake.layer2.dao.bean.UserBean;
...
//    }
    ...
    private int checkSponsor(String sponsor) {
        int sponsorId = -1;
        ...
        try {
            ...
            if (sponsorId <= 0) return -1;
            return sponsorId;
        } catch (Exception e) {
            logger.error("sponsorId is not number");
            return sponsorId;
        }
    }
...
//        try {
//            // test user name vs pass lay tu mysql database
